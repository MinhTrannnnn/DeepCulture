...
export class DynastyRepositoryImpl implements DynastyRepository {
    ...
    async create(dynasty: Omit<Dynasty, 'id' | 'createdAt' | 'updatedAt'>): Promise<Dynasty> {
    ...
    async findById(id: string): Promise<Dynasty | null> {
    ...
    async update(id: string, data: Partial<Dynasty>): Promise<Dynasty> {
